        ...
        init: function () {
            ...
            function updateNamesContainer() {
              ...
              $.each(names, function(index, name) {
                const listItem = $("<li>").text(name).addClass("team-list-item");
                nameList.append(listItem);
              });
              namesContainer.append(nameList);
            }
      
            $("#createTeams").on("click",function() {
              const resultDiv = $("#sonucteam");
              const teamCount = parseInt($("#teamCountInput").val(), 10);
              $("#sonucteam .team-list").css("display","none");
              if (names.length < 2 || teamCount < 1) {
                resultDiv.html("You must enter at least 2 names and create at least 1 team.");
                return;
              }
              $("#createTeams").prop("disabled", true);
              ...
              $.each(teams, function(index, team) {
                const teamDiv = $("<div>").addClass("team-div");
                teamDiv.append("<h3>Team " + (index + 1) + ":</h3>");
      
                const teamList = $("<ul>").addClass("team-list");
                $.each(team, function(i, member) {
                  const listItem = $("<li>").text(member).addClass("team-list-item");
